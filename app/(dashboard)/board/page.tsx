...
export default function BoardPage() {
  ...
  // Prevent Next.js hydration errors by waiting for the client to mount
  useEffect(() => {
    setMounted(true);
  }, []);

  // Fetch data ONLY when the status is idle to prevent infinite dispatch loops
  useEffect(() => {
    if (user && status === "idle") {
  ...
  // Shield the DND context from rendering before data and browser are ready
